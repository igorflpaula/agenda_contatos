...
<head>
    ...
    <title>Criar Novo Contato | CONTIGRO</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Criar Novo Contato</h1>

        <form method="post" action="/index.php?action=create_contato">
            ...
            <div class="form-group">
                ...
                <textarea id="endereco" name="endereco" class="form-control"></textarea>
            </div>
            <div class="form-group">
